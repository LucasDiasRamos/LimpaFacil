...
import br.com.limpafacil.service.ComprovanteService;
import br.com.limpafacil.service.PagamentoService;
import br.com.limpafacil.service.ProdutoService;
import br.com.limpafacil.service.VendaService;
...
public class VendaController {
    ...
    private final ComprovanteService comprovanteService = new ComprovanteService();
    ...
    private void confirmarVenda() {
        try {
            ...
            Venda venda = vendaService.registrarVenda(itens, formaPagamentoComboBox.getValue(), valorRecebido);
