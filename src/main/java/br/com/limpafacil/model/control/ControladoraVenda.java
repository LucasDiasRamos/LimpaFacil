...
public class ControladoraVenda {
    ...
    public Venda registrarVenda(List<ItemVenda> itens, FormaPagamento formaPagamento, BigDecimal valorRecebido) {
        return registrarVenda(itens, formaPagamento, valorRecebido, null);
    }

    public Venda registrarVenda(List<ItemVenda> itens, FormaPagamento formaPagamento, BigDecimal valorRecebido, Cliente cliente) {
        validarItens(itens);
